"""
Extract the downloaded SAP data to a new extracted dir. This is a two step process:
1. Extract the tar files in the DEV and TRAIN folders to a new extracted dir 
2. Search for any nested tar files in the extracted dir and extract those in place, then remove the nested tar files
"""
...
def get_args():
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("VallE/egs/sap/"),
        help="The location you wish to output the extracted SAP data. Eg. /scratch/<user>/VallE/egs/sap"
    )

    parser.add_argument(
        "--raw-sap-dir",
        type=Path,
        default=Path("VallE/egs/sap/download"),
        help="The location of the downloaded SAP data. Eg. /scratch/<user>/VallE/egs/sap/download"
    )
...
def main():
    ...
    extract_sap(args.raw_sap_dir, args.output_dir, subfolders)
